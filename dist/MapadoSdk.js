...
function createEntity(val){var type=arguments.length<=1||arguments[1]===undefined?null:arguments[1];
return(0,_immutable.fromJS)(val);}var


MapadoSdk=function(){
function MapadoSdk(oauthClient,config){var _this=this;var clientList=arguments.length<=2||arguments[2]===undefined?{}:arguments[2];var entityFactory=arguments.length<=3||arguments[3]===undefined?createEntity:arguments[3];_classCallCheck(this,MapadoSdk);
...
_this[key]=new clientList[key](_this);});}_createClass(MapadoSdk,[{key:'_mergeWithBaseConfig',value:function _mergeWithBaseConfig(
...
throw new RangeError('SDK config is not valid, it should contain a "path", a "scheme" parameter,\n        and may contain a "port" and a "useDefaultParameters" parameter');}}}]);return MapadoSdk;}();exports.default=
